...
void main()
{
    ...
    printf("\t\tThe Following Trains "
           "Are Available.....\n");
    printf("\t\t1. HIMALYAN QUEEN (52455).."
           ".......10:00 "
           "a.m........SHIVALK DLX EXP (52451)\n");
    printf("\t\t2. Satabdi Express..."
           ".......05:00 "
           "p.m........NETAJI EXPRESS (12311)\n");
    printf("\t\t3. Humsafar Express..."
           ".......11:00 "
           "p.m........KLK SML EXPRESS (52459)"
           " Station\n");
    ...
    do {
        ...
        case 5: {
            ...
            strcpy(station, "New Delhi Railway Station");
            time1 = 07;
            time2 = 00;
            a1 = 2205;
            a2 = 1905;
